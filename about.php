...
<div class="header">
		...
		<div class="logo">
			...
			<div class="header-ri">
				<ul class="social-top">
					<li><a href="https://www.facebook.com" class="icon twitter"><i class="fa fa-facebook" aria-hidden="true"></i><span></span></a></li>
					<li><a href="https://twitter.com" class="icon twitter"><i class="fa fa-twitter" aria-hidden="true"></i><span></span></a></li>
					<li><a href="https://www.instagram.com" class="icon twitter"><i class="fa fa-instagram" aria-hidden="true"></i><span></span></a></li>
					<li><a href="https://api.whatsapp.com/send?phone=918433454131&amp;text=Hi there!" class="icon twitter"><i class="fa fa-whatsapp" aria-hidden="true"></i><span></span></a></li>
					<li><a href="mailto:shop.vegikart@gmail.com" class="icon twitter"><i class="fa fa-google-plus" aria-hidden="true"></i><span></span></a></li>
				</ul>	
			</div>
...
<!-- faqs -->
	...
	<div class="spec ">
			...
			<div class="col-md-4 about-left">
				...
				<p>We are the students of <mark>Chandigarh University</mark> and our goal is to <mark>#VocalforLocal</mark></p>
			</div>
			<div class="col-md-4 about-right">
