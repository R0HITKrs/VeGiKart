	...
	<div class="container">
		...
		<div class="clearfix"></div>
			...
			<h2><span style="color:yellow;">आपकी अपनी सब्जी मंडी</span></h2>
				...
				<ul class="social-fo">
					<li><a href="https://www.instagram.com/" class=" face"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
					<li><a href="https://twitter.com/vegykart" class=" twi"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
					<li><a href="https://www.instagram.com/" class="twi"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
